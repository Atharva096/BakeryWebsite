          ...
          <div className="text-center">
            ...
            <div className="border-t border-orange-700 pt-6">
              <p className="text-orange-300">
                Aishwarya Bakery is your one-stop destination for freshly baked delights that combine tradition with innovation. Renowned for its wide range of cakes, bread, cookies, and snacks, Aishwarya Bakery is committed to delivering high-quality products made with love and precision.
